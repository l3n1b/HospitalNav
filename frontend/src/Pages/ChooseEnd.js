    ...
    return (
        <div className='ChooseEnd'>
            ...
            <div className='container'>
                ...
                <div class="card">
                    <div class="container">
                        <a href={start + '/X-Ray_MRI'}>
                            X-Ray, MRI, and Radiology
                ...
                <div class="card">
                    <div class="container">
                        <a href={start + '/Vascular Interventional Radiology'}>
                ...
                <div class="card">
                    <div class="container">
                        <a href={start + '/Kentucky Neuroscience Institute'}>
                ...
                <div class="card">
                    <div class="container">
                        <a href={start + '/Anesthesia Preop Services'}>
                            Anesthesia Preop Services
                            <span className='clickable-card'></span>
                        </a>
                ...
                <div class="card">
                    <div class="container">
                        <a href={start + '/Physical_Occupational Therapy'}>
                ...
                <div class="card">
                    <div class="container">
                        <a href={start + '/Image Records Center'}>
